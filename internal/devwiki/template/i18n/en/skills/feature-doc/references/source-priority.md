...
1. `wiki/`
   - Start with existing capability pages and feature pages to avoid re-discovering known context.
2. `raw/`
...
- If code and docs disagree, say so explicitly in the generated feature page.
