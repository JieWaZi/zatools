...
func TestServiceAddBuiltinDevwikiLibrary(t *testing.T) {
	...
	wantSkills := []string{"devwiki-code-to-doc", "devwiki-ingest", "devwiki-maintain", "devwiki-project-router", "devwiki-qmd-sync", "devwiki-query", "devwiki-topic", "devwiki-workflow"}
